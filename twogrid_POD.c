...
main(int argc, char *argv[])
{
    ...
    coarseuhs = phgAlloc(TotalN1 * sizeof(*coarseuhs));
  ...
  /********************************************************************/	
   ...
   {   /* update u_p */
        phgDofFree(&u_p);
        u_p = phgDofCopy(uu_h, NULL, DOF_P1, "u_p1");
    ...
    phgFEMLoopTime3(crtime, uu_h, u_p, C, CosG1, CosG2, b);
    kk++;
   	coarseuhs[kk] = phgDofCopy(uu_h, NULL, DOF_P1, "u_p1");
