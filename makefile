...
OBJS2=APODheat.o src/BuildFEM.o
...
APODheat.o: /opt/local-MVAPICH2/phg-0.9.2/lib/libphg.so PODheat.c fun.h

FEMheat:/opt/local-MVAPICH2/phg-0.9.2/lib/libphg.so ${OBJS1}
	${LINKER} ${USER_LDFLAGS} ${LDFLAGS} -o $@ ${OBJS1}${USER_LIB} ${LIBS}

APODheat:/opt/local-MVAPICH2/phg-0.9.2/lib/libphg.so ${OBJS2}
